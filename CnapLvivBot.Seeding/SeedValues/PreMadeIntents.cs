...
namespace CnapLvivBot.Seeding.SeedValues
{
	public static class PreMadeIntents
	{
		...
		public static readonly Intent Kid12Years = new Intent { Content = "дитина до 12 років", id = nameof(Kid12Years) };
		...
		public static readonly Intent Get = new Intent { Content = "взяти", id = nameof(Get) };
